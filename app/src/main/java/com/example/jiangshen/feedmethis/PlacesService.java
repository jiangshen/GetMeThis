...
public class PlacesService {
    ...
    public List<Place> findPlaces(double latitude, double longitude,String placeSpacification, String keyword)
    {

        String urlString = makeUrl(latitude, longitude,placeSpacification, keyword);
    ...
    private String makeUrl(double latitude, double longitude,String place, String keyword) {
        StringBuilder urlString = new StringBuilder("https://maps.googleapis.com/maps/api/place/search/json?");
        String keywords = place + "|" + keyword;
...
//            }
        if (!keywords.equals("")) {
            urlString.append("&keyword="+keywords.trim().replace(' ', '+'));
        }
